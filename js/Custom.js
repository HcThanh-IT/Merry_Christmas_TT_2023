...
function showSantaClaus() {
    ...
    size = Math.floor(Math.random() * 5 + 1) + zoom;
            ...
            $('#reindeer').animate({
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        ...
                        "Chúc chị Thanh Tâm xinhh đẹpp có một ngày giáng sinh an lành ấm áp bên người thân và bạn bè nè. Mãi iuuu 🎄🎄🎄",
                        ],
                        typeSpeed: 50,
                        startDelay: 500,
                        backSpeed: 50,
